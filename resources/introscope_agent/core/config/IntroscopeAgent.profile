...
introscope.autoprobe.directivesFile=tomcat-typical.pbl,webservices.pbd,hotdeploy
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.jmx.name.primarykeys=worker,type,name,context
...
introscope.agent.jmx.name.filter=ThreadPool,Connector,Manager,DataSource,OperatingSystem,Threading
...
# The default is true
# You must restart the managed application before changes to this property take effect.
introscope.autoprobe.deepinheritance.auto.turnoff.enable=false
